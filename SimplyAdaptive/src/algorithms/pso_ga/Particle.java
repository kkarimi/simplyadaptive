...
public class Particle {
	 ...
	 * @param maxPosition : Vector stating maximun position for each dimension
	 * @param minPosition : Vector stating minimum position for each dimension
	 * @param maxVelocity : Vector stating maximun velocity for each dimension
	...
	public Object selfFactory() {
		...
		try {
			cons = cl.getConstructor(new Class[] { Particle.class });
